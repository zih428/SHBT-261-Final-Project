...
\begin{table}[t]
    ...
    \caption{Official validation headline comparison. Bold entries mark the stronger system-level metric. The paired gain is computed over the same 5,000 validation questions and is therefore a stronger test than comparing independent intervals alone.}
